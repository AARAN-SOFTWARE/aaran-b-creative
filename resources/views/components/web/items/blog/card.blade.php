...
<div class="bg-white rounded-2xl">
    ...
    <div class="relative">
        <img src="{{ \Illuminate\Support\Facades\Storage::url('/images/'.$first->image) }}" alt="" class="w-full h-[24rem] rounded-t-2xl">
        <div
    ...
    <div class="pt-12  space-y-5 ">
        ...
        <div class="px-5 uppercase font-merri text-2xl tracking-wider">{{\Illuminate\Support\Str::words($first->vname,10)}}</div>
        ...
        <div class="px-5 text-xs border-t py-5 flex justify-between items-center">
            <span class="text-gray-500">Post By - <span class="text-orange-700 font-normal">{{$first->user->name,10}}</span></span>
