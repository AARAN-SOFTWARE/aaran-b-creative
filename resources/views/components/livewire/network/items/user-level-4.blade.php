...
@foreach($list as $row)
    <div class="w-16 h-[70px] ">
        <div class="w-full h-full relative flex-col flex justify-end">
            <div class="absolute bottom-8 left-3 w-10 h-10 bg-gray-300 p-1 rounded-full">
            ...
            <div class="border border-gray-300 h-12 bg-white text-[8px] font-bold text-gray-500 flex-col flex items-center justify-end rounded-md py-1">
                <div>{{ $row->name }}</div>
