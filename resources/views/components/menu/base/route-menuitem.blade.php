...
<li class="bg-gray-50 ">
    <a {{$attributes}}
       class="relative flex flex-row items-center h-11 focus:outline-none hover:bg-violet-500
                                   text-gray-500 hover:text-gray-200 border-b border-gray-300 hover:border-white pr-6 pl-6 group">
