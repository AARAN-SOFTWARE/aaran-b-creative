<div class="relative z-50 flex flex-col w-full h-40 bg-white font-lex">
    ...
    black , green[#684DF4]
    black , violet[#684DF4]
    #E2EAFF , violet[#684DF4]
    #1C1E22, yellow[#FFAA17]
    black, orange[#FF613C]
    #FDF5F3, orange[#FF613C]
    black, darkred[#ED2C41]
    #EFF1F4, darkred[#ED2C41]
    #CDCED5, yellow[#E17F27]
    black, yellow[#E17F27]
    gray-200, cyan[#0097DA]
    gray-200, peacock[#025594]
    -->

    <div class="h-1 bg-gray-700"></div>
    {{-- <div class="self-end w-2/3 h-16 transform bg-[#055f73] "> --}}
    <div
        class="self-end w-2/3 h-12 bg-gray-700 flex justify-center gap-5 items-center [clip-path:polygon(0%_0%,_100%_0%,_100%_100%,_5%_100%)]">
        <div class="flex flex-row items-center justify-center text-sm font-semibold text-white gap-x-5">
            <svg xmlns="http://www.w3.org/2000/svg" fill="none" viewBox="0 0 24 24" stroke-width="1.5"
                 stroke="currentColor" class="text-[#FF613C] size-4">
                <path stroke-linecap="round" stroke-linejoin="round"
                      d="M11.48 3.499a.562.562 0 0 1 1.04 0l2.125 5.111a.563.563 0 0 0 .475.345l5.518.442c.499.04.701.663.321.988l-4.204 3.602a.563.563 0 0 0-.182.557l1.285 5.385a.562.562 0 0 1-.84.61l-4.725-2.885a.562.562 0 0 0-.586 0L6.982 20.54a.562.562 0 0 1-.84-.61l1.285-5.386a.562.562 0 0 0-.182-.557l-4.204-3.602a.562.562 0 0 1 .321-.988l5.518-.442a.563.563 0 0 0 .475-.345L11.48 3.5Z"/>
            </svg>
            <span>Welcome to the Aaran business Creative</span>
            <span class="inline-flex items-center gap-3"><svg width="" height="" viewBox="0 0 90 90"
                ...
                <svg width="" height="" viewBox="0 0 90 90" fill="none" xmlns="http://www.w3.org/2000/svg"
                     class="w-4 h-4">
                    ...
                    <path
                        ...
                        fill="#FF613C"/>
                    <path d="M36.8125 57.0766L57.7216 45.1821L36.8125 33.2871V57.0766Z" fill="#FDF5F3"/>
                </svg>
            </span>
        </div>
    </div>
    <div class="flex items-center justify-center w-full h-16">
        <div class="flex flex-row items-center justify-between w-8/12">
            ...
            <div class="flex flex-row w-8/12 justify-evenly ">
                <div class="inline-flex items-center font-bold gap-x-5">
                    <svg xmlns="http://www.w3.org/2000/svg" viewBox="0 0 24 24" fill="currentColor"
                         class="size-6 fill-[#FF613C]">
                    ...
                    <div>
                        ...
                        <div class="text-sm text-gray-600 capitalize">9876543210</div>
                ...
                <button class="px-8 py-2 text-white bg-[#FF613C] rounded-br-2xl font-semibold">
                    Join now
                </button>
            </div>
        </div>
    </div>
    <div class="absolute bottom-0 w-full h-1 bg-[#FF613C]"></div>
    <div
