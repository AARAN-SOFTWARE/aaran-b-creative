...
<li class="flex align-center flex-col cursor-pointer ">
    ...
    <div
        ...
        class="relative flex flex-row justify-between items-center h-11 focus:outline-none hover:bg-violet-500
                                text-gray-700 hover:text-white border-b border-gray-300 px-4 group">
                        <span class="inline-flex justify-center items-center space-x-3 py-2">
    ...
    <div x-show="selected === 6" class="flex flex-col">
        ...
        <ul class="grid-cols-1 grid bg-white">
