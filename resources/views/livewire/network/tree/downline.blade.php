<div class="space-y-10">
    ...
    <div class="min-h-screen overflow-auto flex items-center bg-gray-50 rounded-md font-lex">

        <div class=" flex-col flex items-center justify-center py-10">

            <!--  Level 0  -->
            <x-livewire.network.items.user :current-user="$currentUser"/>
            <!--  Level 1  -->
            <div class="w-[780] flex-col flex items-center">
                <div class="w-1 h-2 border-l-2 border-gray-400"></div>
                <div class="w-[780px] mx-auto h-2 border-t-2 border-l-2 border-r-2 border-gray-400"></div>
            </div>
            <div class="w-[850px] flex  justify-between">
                <x-livewire.network.items.user-level-1 :list="$children"/>
            </div>
            <!--  Level 2  -->
            ...
            <div class="w-[1650px] flex justify-between space-x-0.5">
                @for($i=1; $i<=32; $i++)
                    <div class="w-[52px] flex-col flex items-center">
                        <div class="w-1 h-2 border-l-2 border-gray-400"></div>
                        <div class="w-[22px] mx-auto h-2 border-t-2 border-l-2 border-r-2 border-gray-400"></div>
                    </div>
                @endfor
            </div>
            <div class="flex w-[1660px] justify-evenly ">
