            ...
            <div class="bg-white p-6 rounded-lg shadow-md w-full max-w-md">
                ...
                <form id="editProfileForm">
                    <div class="mb-4">
                        ...
                        <input type="text" id="name" name="name" value="John Doe" required class="mt-1 block w-full p-2 border border-gray-300 rounded-md focus:ring focus:ring-blue-500">
                    </div>
                    <div class="mb-4">
                        <label for="email" class="block text-sm font-medium text-gray-700">Email</label>
                        <input type="email" id="email" name="email" value="john.doe@example.com" required class="mt-1 block w-full p-2 border border-gray-300 rounded-md focus:ring focus:ring-blue-500">
                    </div>
                    <button type="submit" class="w-full bg-green-600 hover:bg-green-700 text-white font-bold py-2 rounded-md">Save Changes</button>
                </form>
                <button id="closeModal" class="mt-4 w-full bg-red-500 hover:bg-red-600 text-white font-bold py-2 rounded-md">Cancel</button>
            </div>
        </div>
